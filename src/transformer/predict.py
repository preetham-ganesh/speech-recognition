...
class SpeechRecognition(object):
    ...
    def predict(self, file_path: str) -> str:
        ...
        Args:
            file_path: A string for the location where the features of the audio file is located.
        ...
        # Loads & preprocesses features of audio file based on model requirements.
        features = self.load_preprocess_input(file_path)
